...
public final class HandlerSchedulerTest {
    ...
    @Test
    public void directSchedulePostsImmediately() {
    ...
    @Test
    public void directScheduleUsesHook() {
    ...
    @Test
    public void directScheduleDisposedDoesNotRun() {
        CountingRunnable counter = new CountingRunnable();
    ...
    @Test
    public void directScheduleWithDelayPostsWithDelay() {
        CountingRunnable counter = new CountingRunnable();
    ...
    @Test
    public void directScheduleWithDelayUsesHook() {
        final CountingRunnable newCounter = new CountingRunnable();
        final AtomicReference<Runnable> runnableRef = new AtomicReference<>();
        RxJavaPlugins.setScheduleHandler(new Function<Runnable, Runnable>() {
            @Override public Runnable apply(Runnable runnable) {
    ...
    @Test
    public void directScheduleWithDelayDisposedDoesNotRun() {
        CountingRunnable counter = new CountingRunnable();
    ...
    @Test
    public void workerSchedulePostsImmediately() {
    ...
    @Test
    public void workerScheduleUsesHook() {
        final CountingRunnable newCounter = new CountingRunnable();
        final AtomicReference<Runnable> runnableRef = new AtomicReference<>();
        RxJavaPlugins.setScheduleHandler(new Function<Runnable, Runnable>() {
            @Override public Runnable apply(Runnable runnable) {
    ...
    @Test
    public void workerScheduleDisposedDoesNotRun() {
        Worker worker = scheduler.createWorker();
    ...
    @Test
    public void workerScheduleWithDelayPostsWithDelay() {
        Worker worker = scheduler.createWorker();
    ...
    @Test
    public void workerScheduleWithDelayUsesHook() {
        final CountingRunnable newCounter = new CountingRunnable();
        final AtomicReference<Runnable> runnableRef = new AtomicReference<>();
        RxJavaPlugins.setScheduleHandler(new Function<Runnable, Runnable>() {
            @Override public Runnable apply(Runnable runnable) {
    ...
    @Test
    public void workerScheduleWithDelayDisposedDoesNotRun() {
        Worker worker = scheduler.createWorker();
    ...
    @Test
    public void scheduleDirectInputValidation() {
        try {
    ...
    @Test
    public void schedulePeriodicallyDirectInputValidation() {
        try {
    ...
    @Test
    public void workerScheduleInputValidation() {
        Worker worker = scheduler.createWorker();
        try {
